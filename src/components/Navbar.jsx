...
export default function BackToTop(props) {
  return (
    <React.Fragment>
      <CssBaseline />
      <AppBar  fontFamily='Tajawal' color='#0000'>
        <Toolbar>
      ...
      <Container>
        <Box my={4} color='#DCDCDC '  fontFamily='Cairo' textAlign='center' fontSize='big'>
          {[...new Array(1)]
            .map(
      ...
      <ScrollTop {...props}>
        <Fab color="#DE6F00 " size="small" aria-label="scroll back to top">
          <KeyboardArrowUpIcon />
        </Fab>
      </ScrollTop>
    </React.Fragment>
